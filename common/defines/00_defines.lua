...
NGame = {
	...
	FUEL_RESOURCE = "food",							-- resource that will give country fuel
...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "171.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NAI = {
	...
	IMPORTANT_VICTORY_POINT = 10,						-- during occupation ai will only care so much to ask for extra garrisons if VP amount is at least this 
